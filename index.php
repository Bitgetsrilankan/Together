                                    ...
                                    $headers = [
                                        "accept: application/json",
                                            "content-type: application/json",
                                                ...
                                                if (curl_errno($ch)) {
                                                    header('Content-Type: application/json');
                                                        echo json_encode(["error" => "Timeout! Try After 2-3 Seconds. API By @BjsWorks"]);
                                                            curl_close($ch);
                                                                exit;
                                                                }
                                                                    ...
                                                                    $image_url = $data['data'][0]['url'];
                                                                        ...
                                                                        // Fetch the image data
                                                                            $image_data = file_get_contents($image_url);
                                                                                if ($image_data === false) {
                                                                                        header('Content-Type: application/json');
                                                                                                echo json_encode(["error" => "Failed to fetch the generated image. API By @BjsWorks"]);
                                                                                                        exit;
                                                                                                            }
                                                                                                                                                                            ...
                                                                                                                                                                            // Execute the request to imgbb
                                                                                                                                                                                    $imgbb_response = curl_exec($ch);
                                                                                                                                                                                            ...
                                                                                                                                                                                            // Handle errors
                                                                                                                                                                                                    if (curl_errno($ch)) {
                                                                                                                                                                                                                header('Content-Type: application/json');
                                                                                                                                                                                                                            echo json_encode(["error" => "Failed to upload to imgbb. API By @BjsWorks"]);
                                                                                                                                                                                                                                        curl_close($ch);
                                                                                                                                                                                                                                                    exit;
                                                                                                                                                                                                                                                            }
                                                                                                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                                                                                                            "by" => "@BjsWorks"
                                                                                                                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                                                                                                                    exit;
                                                                                                                                                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                        // Handle imgbb upload failure
                                                                                                                                                                                                                                                                                                                                                                                                                                                                    header('Content-Type: application/json');
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                echo json_encode(["error" => "Failed to upload the image to imgbb. API By @BjsWorks"]);
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            exit;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    }
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        }
